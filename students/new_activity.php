...
<hr class="sidebar-divider">
         <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800" style="color:maroon;">New Activity</h1>
...
<label for="comment" style ="color: maroon;">Dear our student feel free to type in your Daily work , then CLICK  save activity</label>
<hr class="sidebar-divider" style="background-color:maroon;">

 
 <form method="post" action= "new_activity_code.php" enctype="multipart/form-data" >
    <div class="form-group">
      
      <textarea class="form-control"  name="work" rows="10" id="comment"></textarea>
	...
	<button name="add"  style="background-color: maroon; color: white; border-radius: 10px;">Save Activity</button>
  </form>
</div>
