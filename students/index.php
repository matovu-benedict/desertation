...
function myTimer() {
 ...
 <!--Total Number of administrators-->
              ...
              <div class="card border-left-primary shadow h-100 py-2" style="background-color:maroon;">
                <div class="card-body" style="background-color:black;">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2" >
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Number of  Activities</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                        
                       <?php

                     require 'dbconfig.php';
                        $query = "SELECT id FROM activity WHERE regno='".$_SESSION['regno']."' ORDER BY id";
          ...
          <!--Total Number of aComments------>
            <div class="col-xl-3 col-md-6 mb-4" >
              <div class="card border-left-primary shadow h-100 py-2" style="background-color:maroon;">
                <div class="card-body" style="background-color:black;">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2" >
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Number of  Comments</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                     ...
                     require 'dbconfig.php';
                        $query = "SELECT id FROM comment WHERE regno='".$_SESSION['regno']."' ORDER BY id";
                        $query_run = mysqli_query($connection, $query);
            ...
            <div class="col-xl-3 col-md-6 mb-4" >
              <div class="card border-left-primary shadow h-100 py-2" style="background-color:maroon;">
                <div class="card-body" style="background-color:black;">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2" >
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Number of uploaded files</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                     ...
                     require 'dbconfig.php';
                        $query = "SELECT id FROM files WHERE regno='".$_SESSION['regno']."' ORDER BY id";
                        $query_run = mysqli_query($connection, $query);
