...
<hr class="sidebar-divider" style="background-color:maroon;">
     ...
     <!-- DataTales Example -->
          ...
          $query = "SELECT * FROM activity WHERE supervisorID='$id'";
        ...
        ?>
            ...
            <tr>
              ...
              <th style="color:maroon;">REPLY</th>
           ...
           while($row = mysqli_fetch_assoc($query_run)){
            ?>
              ...
              <td> <?php echo $row['date']; ?></td>
               <td><a href="new_comment.php"> <button class="btn btn-success"><i class="fa fa-view" ></i> REPLY</button></td>
