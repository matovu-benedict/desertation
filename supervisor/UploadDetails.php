      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="UploadDetails.php">Add Your content</a>
          </div>
        </div>
      </li>
...
<h3> Upload Internship Content For Supervisor</h3>
...
<input id="userfile" type="file" name="userfile" /><br><br>
