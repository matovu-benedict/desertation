...
<hr class="sidebar-divider">
         <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800" style="color:maroon;">Comments From Spervisors</h1>
...
<hr class="sidebar-divider" style="background-color:maroon;">
        ...
        ?>
            ...
            <tr>
              ...
              <th style="color:maroon;">COMMENT</th>
              <th style="color:maroon;">COMMENT SENT TO</th>
		  ...
		  <tfoot>
                    <tr>
              <th style="color:maroon;">ID</th>
			   <th style="color:maroon;">SUPERVISOR ID</th>
              <th style="color:maroon;">COMMENT</th>
              <th style="color:maroon;">COMMENT SENT TO</th>
              <th style="color:maroon;">DATE</th>
