...
<hr class="sidebar-divider">
    ...
    <h6 style="color:maroon;">Download Desertation Files </h6>
...
<center>
 ...
 <?php
include 'db.php';
$result = mysql_query("SELECT * FROM coordinator WHERE email='".$_SESSION['username']."'");
           ...
           while($row = mysqli_fetch_assoc($query_run)){
            ?>
             ...
             <td> <?php echo $row['regno']; ?> </td>
              ...
              <?php echo'
               <td><a href="studentContent2.php?id='.$row['id'].'"> <button class="btn btn-success"><i class="fa fa-download"></i> Download</button></td>  
                '?>
        </tr>
